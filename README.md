...
## Overview
This app demonstrates use of a SIG BLE mesh model as indicated by the name of the application.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the WICED board
2. Run the application and refer to the Mesh Client Control user guide. Also refer to the BT SIG Mesh Specification: https://www.bluetooth.com/specifications/mesh-specifications
