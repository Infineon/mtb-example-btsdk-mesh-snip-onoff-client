...
## Overview
This app demonstrates use of a SIG LE mesh model as indicated by the name of the application.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the AIROC&#8482; board
2. Run the application and refer to the Mesh Client Control user guide. Also refer to the Bluetooth&#174; SIG Mesh Specification: https://www.bluetooth.com/specifications/mesh-specifications
...
- DEB\_LPN\_RSP\_TIME
    - Test mode to collect statistics for poll responses. It will a print table of response counters. Each element is two bytes counter represents 10ms delay.
## BTSTACK version
